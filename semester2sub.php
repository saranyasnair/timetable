...
{
$result = mysql_query("insert into semester2subtbl values ('','$_GET[sno]','$_GET[sname]')");
if($result==1)
{
$sid=mysql_query("select max(sid) from semester2subtbl");
...
<form method="get" action="#">
					<table width="500" cellpadding="5" cellspacing="5" align="center">
					    <th>Add Subject of Semester1 </th>
  <tr>
    <td>Subject Id </td>
